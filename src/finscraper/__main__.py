#!/usr/bin/env python3
"""
Main entry point for FinScraper package
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        prog='finscraper',
        description='FinScraper - Professional Financial Data Scraper',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  finscraper add AAPL              # Add Apple stock
  finscraper show                  # Show tickers in beautiful ASCII table
  finscraper export --format json # Export data to JSON
  finscraper refresh               # Refresh all data
  finscraper --gui                 # Launch GUI interface
  finscraper --interactive         # Interactive CLI mode
        """
    )
        ...
        if args.command == 'add':
            ...
            if args.ticker:
                ...
                if args.summary:
                    ...
                    if not data_list:
                        print("No tickers found. Use 'finscraper add TICKER' to add some.")
                    else:
                        print("Available tickers:", ", ".join([d.ticker for d in data_list]))
                        print("Use 'finscraper show TICKER' for detailed view")
                        print("Use 'finscraper show --summary' for summary table")
...
def main():
    ...
    if args.gui:
        ...
        print("Example:")
        print("  from finscraper import FinancialDataScraper")
