...
class FinancialDataGUI:
    ...
    def setup_gui(self):
        """Setup the GUI"""
        self.root = tk.Tk()
        self.root.title("FinScraper - Financial Data Scraper")
    ...
    def show_statistics(self):
        ...
        stats_text = "=== FinScraper Statistics ===\n\n"
...
Built with Python and Tkinter
        """
        messagebox.showinfo("About FinScraper", about_text)
    ...
    def on_closing(self):
        ...
        if messagebox.askokcancel("Quit", "Do you want to quit FinScraper?"):
            self.root.destroy()
